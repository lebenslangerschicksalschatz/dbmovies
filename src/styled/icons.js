export const MovieRatingIcon = ({rating}) => {
  return (
    <div className="movie__rating movie__rating_watchlist">
      <svg viewBox="0 0 36 36" className="circular-chart circular-chart_watchlist">
        <path
          className="circle-bg circle-bg_watchlist"
          d="M18 2.0845 a 15.9155 15.9155 0 0 1 0 31.831 a 15.9155 15.9155 0 0 1 0 -31.831"
        />
        <path
          className="circle circle_watchlist"
          strokeDasharray="78, 100"
          d="M18 2.0845 a 15.9155 15.9155 0 0 1 0 31.831 a 15.9155 15.9155 0 0 1 0 -31.831"
        />
        <text x="18" y="21.5" className="percentage percentage_watchlist">{rating}</text>
      </svg>
    </div>
  )
}
...
export const EyeIcon = () => {
  return (
    <svg
      ...
      data-prefix="fas" data-icon="eye" role="img" viewBox="0 0 576 512"
    >
      <path
        fill="currentColor"
